...
#define IO_CCP2         TRISEbits.TRISE0
#define IO_CCP3         TRISEbits.TRISE1
#define IO_CCP4         TRISEbits.TRISE2
#define IO_CCP5         TRISEbits.TRISE3

/* When using them as inputs you read the values with these aliases. */
#define IN_CCP2         PORTEbits.RE0
#define IN_CCP3         PORTEbits.RE1
#define IN_CCP4         PORTEbits.RE2
#define IN_CCP5         PORTEbits.RE3

/* When using them as outputs you drive a value with these aliases. */
#define OUT_CCP2        LATEbits.LATE0
#define OUT_CCP3        LATEbits.LATE1
#define OUT_CCP4        LATEbits.LATE2
#define OUT_CCP5        LATEbits.LATE3
