...
void inputModifier(unsigned char*,unsigned char*);
void recalc_for_deadband(unsigned int *);
unsigned char motorModifier(unsigned char);
void relayControl(void);
void relayInit(void);
unsigned char period(unsigned int,unsigned char);
void encoderMod(void);
char *ulong2s(unsigned long x, char *buf/*32*/);
